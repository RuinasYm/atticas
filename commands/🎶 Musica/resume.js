...
module.exports = {
  name: "resume",
  alias: [],
  desc: "Sirve para reanudar  una cancion",
  uso: "!resume",
  permisos: ["PREMIUM"],
  ...
  async execute(client, message, args, discord) {
    ...
    if (mvc != pvc.joinConfig.channelId) return message.reply({
      embeds: [new Discord.MessageEmbed()
    ...
    .setAuthor({name: "Cancion Reanudada  ♪", iconURL: client.user.displayAvatarURL({dynamic: true})})
    .setColor("e60ad4")
